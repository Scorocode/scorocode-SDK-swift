...
public struct SCQuery {
    ...
    public var userQuery: [String: Any]? {
        return _userQuery
    }
    ...
    public func find(_ callback: @escaping (Bool, SCError?, [String: Any]?) -> Void) {
    ...
    public func update(_ update: SCUpdate, callback: @escaping (Bool, SCError?, [String: Any]?) -> Void) {
